	...
	$.fn.loading = function(options){
		...
		return this.each(function(){
		    ...
		    var defaultProp = {
				...
				title:                  '温馨提示',      										//显示什么内容
				name: 					'loading', 											//loading的data-name的属性值  用于删除loading需要的参数
				type: 			        'origin', 			  									//pic   origin  
				discription: 			'请稍等...', 										//loading的描述
				...
				loadingMaskBg:    		'rgba(66,66,66,0.6)',          								//背景遮罩层颜色
				zIndex:           		59991014,              									//层级
				...
				flexCenter: 	 		true, 													//是否用flex布局让loading-div垂直水平居中
				flexDirection: 			'column',													//row column  flex的方向   横向 和 纵向
