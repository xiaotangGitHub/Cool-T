...
class Bootstrap extends Paginator
{
    ...
    protected function info(){
        ...
        return "<span class='rows'>共 ". $this->total ." 条记录</span>";
    ...
    public function render()
    {
        if ($this->hasPages()) {
            if ($this->simple) {
                return sprintf(
                    '%s<div class="paginate">%s %s %s</div>',
                    $this->css(),
                    $this->prev(),
                    $this->getLinks(),
                    $this->next()
                ...
                return sprintf(
                    '%s<div class="paginate">%s %s %s %s %s %s</div>',
                    $this->css(),
                    $this->home(),
                    $this->prev(),
                    $this->getLinks(),
    ...
    {
//        return '<p class="pageEllipsis">' . $text . '</a>';
        return $text . '</a>';
    }
